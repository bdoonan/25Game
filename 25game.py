...
def Game(listOfHands, trumpCard):
    ...
    while len(YourHand) > 0:
        ...
        for i in listOfHands:
            ...
            Count2 = 0
            for j in i:
                if j[1] == winningCard[1] and winningCard[1] == trumpCard[1]:
                    randint = i.index(j)
                if j[1] == winningCard[1] and j[1] != trumpCard[1]:
                    randint = i.index(j)
            oppList[oppCount]=i[randint]
            print("Opponent card played:")
            if (card[0] == '5' and card[1]==trumpCard[1]):
                winningCard = card
            ...
            elif (card[0] == 'Jack' and card[1]==trumpCard[1]):
                winningCard = card
            ...
            elif (card[0] == 'Ace' and card[1]=='Hearts'):
                winningCard = card
            ...
            elif (card[0] == 'Ace' and card[1]==trumpCard[1]):
                winningCard = card
            ...
            elif (card[0] == 'King' and card[1]==trumpCard[1]):
                winningCard = card
            ...
            elif (card[0] == 'Queen' and card[1]==trumpCard[1]):
                winningCard = card
